...
###### **NOTE: Everything after this is Physics related and more for my own learning, if you'd like to read on please do so but note it is not fully related to Programming. It may be useful however if youd like to understand how it "solves" the n-body problem**
